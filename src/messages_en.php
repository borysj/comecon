...
$exitmsg_errorSavingComment = "An error occurred while saving your comment.<br>Go back and try again.<br>If the error persists, please send a message to {$settings['email']['blogContactMail']}";
$exitmsg_errorRunningCommentScript = "An error occurred while activating the comment script.<br>>Go back to the comment form and try again.<br>If the error persists, please send a message to {$settings['email']['blogContactMail']}";
...
$msg_commentInContext = "The comments could have been changed or deleted in the meanwhile. Follow the link to the blog to find the most recent version.";
$msg_commentFeedEntryTitle = "Comment for the blog post";
...
$label_searchTitle = "Searched phrase";
$label_searchResult = "Number of pages with the searched phrase";
$label_searchResultComments = "Number of pages where the searched phrase is in the comments";
